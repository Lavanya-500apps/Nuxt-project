...
export const useAuthLazyFetch = (request: any, options: any | undefined | null) => {
    ...
    let token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1IjoiYjJkNzc4NjRiM2IyNDc0NmJjYmNiZjk2YTI5MzI0ODAiLCJkIjoiMTY4MDA4NSIsInIiOiJzYSIsInAiOiJmcmVlIiwiYSI6ImZpbmRlci5pbyIsImwiOiJ1czEiLCJleHAiOjE2ODMyNzk5NDN9.Fo7IMGb9o9ni-D2nYHfGa3bs_rUJf0bqB6RThBB5-Cc'
